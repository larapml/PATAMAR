...
function store_init() {
    ...
    for (let item in store) {
        let item_div = $("<div class='col-sm-4 col-12' style='margin-bottom: 25px;'>");
        ...
        store[item].description.forEach(function(description) {
            item_div.append($("<p class='no-space' style='text-align: left; margin-bottom: 0px; font-size: 12px;'>").text(description));
        });
